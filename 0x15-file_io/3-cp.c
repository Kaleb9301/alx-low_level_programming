...
/**
 * check97 - cheks for the correct numbe of arguments
...
/**
 * check99 - checs that file_to was creat and/or can be writen to
 * @check: checs if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descirptor of file_to, or -1
 *
 * Return: void
 */
 ...
 * @argc: number fo arguments passed
